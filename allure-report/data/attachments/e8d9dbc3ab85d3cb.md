...
Call log:
  - waiting for locator('ajs-button btn btn-primary') to be visible
  ...
  - generic [ref=f4e2]:
      ...
      - generic [ref=f4e81]:
        - generic [ref=f4e82]:
          - generic:
            ...
            - generic [ref=f4e98]: Records 1 to 10 of 887
          - generic [ref=f4e100]:
        ...
        - generic [ref=f4e719]:
          - generic:
            ...
            - generic [ref=f4e735]: Records 1 to 10 of 887
          - generic [ref=f4e737]:
    ...
    - generic [ref=f4e749]:
      ...
      - link "Back to Top" [ref=f4e753] [cursor=pointer]:
        - /url: javascript:void(0);
      - generic [ref=f4e754]: Your session will expire in 161 seconds.
  - generic [ref=f4e755]:
    - button [ref=f4e756] [cursor=pointer]
    - generic [ref=f4e757]:
      - button [ref=f4e758] [cursor=pointer]
      - button [ref=f4e759] [cursor=pointer]
    - generic [ref=f4e760]: Alert
    - generic [ref=f4e761]: Add succeeded
    - button "OK" [ref=f4e767] [cursor=pointer]
    - button [ref=f4e768] [cursor=pointer]
  - generic [ref=f4e769]:
    - button [ref=f4e770] [cursor=pointer]
    - generic [ref=f4e771]:
      - button [ref=f4e772] [cursor=pointer]
      - button [ref=f4e773] [cursor=pointer]
    - generic [ref=f4e774]: Logout
    - generic [ref=f4e775]: Are you sure you want to logout?
    - generic [ref=f4e779]:
      - button "OK!" [ref=f4e780] [cursor=pointer]
      - button "Cancel" [ref=f4e781] [cursor=pointer]
    - button [ref=f4e782] [cursor=pointer]
```
...
```ts
  ...
  44  |     this.AlertOk=page.locator('ajs-button btn btn-primary')
