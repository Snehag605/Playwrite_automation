...
```
Error: locator.waitFor: Error: strict mode violation: getByText('OK') resolved to 7 elements:
    1) <span>↵Joko Sentul</span> aka getByText('Joko Sentul')
    2) <button class="ajs-button btn btn-primary">OK</button> aka getByRole('button', { name: 'OK' })
    3) <button type="button" aria-hidden="true" data-dismiss="modal" class="btn btn-primary ewButton">OK</button> aka locator('#msTACDialog').getByText('OK')
    4) <button type="button" aria-hidden="true" data-dismiss="modal" class="btn btn-primary ewButton">OK</button> aka locator('#msAboutDialog').getByText('OK')
    5) <button type="button" data-dismiss="modal" class="btn btn-primary ewButton">OK</button> aka getByText('OK').nth(4)
    6) <button type="button" class="btn btn-primary ewButton">OK</button> aka locator('#ewPrompt').getByText('OK')
    7) <button type="button" data-dismiss="modal" class="btn btn-primary ewButton">OK</button> aka locator('#ewTimer').getByText('OK', { exact: true })
  ...
  - generic [ref=f4e2]:
        ...
        - generic [ref=f4e82]:
          - generic:
            ...
            - generic [ref=f4e86]:
              ...
              - generic [ref=f4e97]: of 89
            - generic [ref=f4e98]: Records 1 to 10 of 885
          - generic [ref=f4e100]:
              ...
              - generic [ref=f4e726]:
                ...
                - generic [ref=f4e729]:
                  ...
                  - link "" [ref=f4e732] [cursor=pointer]:
                    - /url: a_supplierslist.php?start=881
              - generic [ref=f4e734]: of 89
            - generic [ref=f4e735]: Records 1 to 10 of 885
          - generic [ref=f4e737]:
    ...
    - generic [ref=f4e749]:
      ...
      - link "Back to Top" [ref=f4e753] [cursor=pointer]:
        - /url: javascript:void(0);
  - generic [ref=f4e754]:
    - button [ref=f4e755] [cursor=pointer]
    - generic [ref=f4e756]:
      - button [ref=f4e757] [cursor=pointer]
      - button [ref=f4e758] [cursor=pointer]
    - generic [ref=f4e759]: Alert
    - generic [ref=f4e760]: Add succeeded
    - button "OK" [ref=f4e766] [cursor=pointer]
    - button [ref=f4e767] [cursor=pointer]
  - generic [ref=f4e768]:
    - button [ref=f4e769] [cursor=pointer]
    - generic [ref=f4e770]:
      - button [ref=f4e771] [cursor=pointer]
      - button [ref=f4e772] [cursor=pointer]
    - generic [ref=f4e773]: Logout
    - generic [ref=f4e774]: Are you sure you want to logout?
    - generic [ref=f4e778]:
      - button "OK!" [ref=f4e779] [cursor=pointer]
      - button "Cancel" [ref=f4e780] [cursor=pointer]
    - button [ref=f4e781] [cursor=pointer]
```
